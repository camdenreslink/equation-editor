eqEd.LeftAbsValBracket = function(fontMetrics) {
    ...
    this.wholeBracket = new eqEd.LeftAbsValWholeBracket("MathJax_Main", this.fontMetrics);
...
(function() {
    ...
    eqEd.LeftAbsValBracket.prototype.updateBracketStructure = function() {
        ...
        for (var i = 0; i < numberOfMiddleBrackets; i++) {
            var middleBracket = new eqEd.LeftAbsValMiddleBracket(i, this.fontMetrics);

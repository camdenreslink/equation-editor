...
(function() {
    ...
    eqEd.SquareRootRadical.prototype.buildDomObj = function() {
        ...
        if(Modernizr.svg) {
            ...
            htmlRep = '<div class="squareRootRadical"><img class="nonHighlightVersion eqImg" src="../../Images/radical.png" /><img class="highlightVersion eqImg" src="../../Images/radicalHighlight.png" /></div>';
        }

eqEd.RightCurlyBracket = function(fontMetrics) {
    ...
    this.wholeBracket = new eqEd.RightCurlyWholeBracket("MathJax_Main", fontMetrics);
...
(function() {
    ...
    eqEd.RightCurlyBracket.prototype.updateBracketStructure = function() {
        ...
        this.children = [];
        if (this.heightRatio <= 1.5) {
            this.wholeBracket = new eqEd.RightCurlyWholeBracket("MathJax_Main", this.fontMetrics);
            this.wholeBracket.parent = this;
            this.domObj.append(this.wholeBracket.domObj);
            this.children = [this.wholeBracket];
        } else if (this.heightRatio > 1.5 && this.heightRatio <= 2.4) {
            this.wholeBracket = new eqEd.RightCurlyWholeBracket("MathJax_Size3", this.fontMetrics);
            this.wholeBracket.parent = this;
            this.domObj.append(this.wholeBracket.domObj);
            this.children = [this.wholeBracket];
        } else if (this.heightRatio > 2.4 && this.heightRatio <= 3) {
            this.wholeBracket = new eqEd.RightCurlyWholeBracket("MathJax_Size4", this.fontMetrics);
            this.wholeBracket.parent = this;
            this.domObj.append(this.wholeBracket.domObj);
            this.children = [this.wholeBracket];
        } else {
            ...
            this.topBracket = new eqEd.RightCurlyTopBracket(this.fontMetrics);
            this.bottomBracket = new eqEd.RightCurlyBottomBracket(this.fontMetrics);
            ...
            for (var i = 0; i < Math.round(0.5 * numberOfMiddleBrackets); i++) {
                var middleBracket = new eqEd.RightCurlyMiddleBracket(i, "middleVert", this.fontMetrics);
                middleBracket.parent = this;
                this.domObj.append(middleBracket.domObj);
                this.middleBrackets.push(middleBracket);
            }
            var middleCurly = new eqEd.RightCurlyMiddleBracket(Math.round(0.5 * numberOfMiddleBrackets), "middleCurly", this.fontMetrics);

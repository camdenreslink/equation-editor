eqEd.LeftFloorBracket = function(fontMetrics) {
    ...
    this.wholeBracket = new eqEd.LeftFloorWholeBracket("MathJax_Main", this.fontMetrics);
...
(function() {
    ...
    eqEd.LeftFloorBracket.prototype.updateBracketStructure = function() {
        ...
        if (this.heightRatio <= 1.5) {
            ...
            this.wholeBracket = new eqEd.LeftFloorWholeBracket("MathJax_Size3", this.fontMetrics);
            this.wholeBracket.parent = this;
            this.domObj.append(this.wholeBracket.domObj);
            this.children = [this.wholeBracket];
        } else if (this.heightRatio > 2.4 && this.heightRatio <= 3) {
            this.wholeBracket = new eqEd.LeftFloorWholeBracket("MathJax_Size4", this.fontMetrics);
            this.wholeBracket.parent = this;
            this.domObj.append(this.wholeBracket.domObj);
            this.children = [this.wholeBracket];
        } else {
            var numberOfMiddleBrackets = Math.ceil((this.heightRatio - 0.6)/0.45) + 1;
            this.bottomBracket = new eqEd.LeftFloorBottomBracket(this.fontMetrics);
            this.bottomBracket.parent = this;
            this.domObj.append(this.bottomBracket.domObj);
            for (var i = 0; i < numberOfMiddleBrackets; i++) {
                var middleBracket = new eqEd.LeftFloorMiddleBracket(i, this.fontMetrics);

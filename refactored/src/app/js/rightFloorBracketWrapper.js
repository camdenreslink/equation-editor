eqEd.RightFloorBracketWrapper = function(symbolSizeConfig) {
    eqEd.RightBracketWrapper.call(this, symbolSizeConfig); // call super constructor.
    this.className = "eqEd.RightFloorBracketWrapper";

    this.matchingBracketCtor = eqEd.LeftFloorBracketWrapper;
...
(function() {
    ...
    eqEd.RightFloorBracketWrapper.prototype = Object.create(eqEd.RightBracketWrapper.prototype);
    eqEd.RightFloorBracketWrapper.prototype.constructor = eqEd.RightFloorBracketWrapper;
    eqEd.RightFloorBracketWrapper.prototype.buildDomObj = function() {
        return new eqEd.WrapperDom(this,
            '<div class="wrapper bracketWrapper rightBracketWrapper rightFloorBracketWrapper"></div>')
    };
    // This is a callback that happens after this.heightRation gets calculated.
    eqEd.RightFloorBracketWrapper.prototype.updateBracketStructure = function() {
        this.domObj.empty();
        ...
        if (this.heightRatio <= 1.5) {
            ...
            this.childNoncontainers = (this.middleBrackets).concat([this.bottomBracket]);
        }
    }
})();
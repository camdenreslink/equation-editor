...
eqEd.Container.prototype.addWrappers = function(indexAndWrapperList) {
    ...
    for (var i = 0; i < indexAndWrapperList.length; i++) {
        ...
        // TODO This code is jQuery dependent...want to at some point
        // make this code DOM library independent.
        this.domObj.insertAt(index, wrapper.domObj);
    }
...
eqEd.Container.prototype.removeWrappers = function(indexList) {
    ...
    for (var i = 0; i < indexList.length; i++) {
        ...
        // TODO This code is jQuery dependent...want to at some point
        // make this code DOM library independent.
        this.domObj.children().eq(indexList[i] - correction).remove();
        correction += 1;
    }
    this.updateWrapperProperties();
    this.updateAll();

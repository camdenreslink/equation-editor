eqEd.RightAngleBracket = function(fontMetrics) {
    ...
    this.wholeBracket = new eqEd.RightAngleWholeBracket("MathJax_Main", this.fontMetrics);
...
(function() {
    ...
    eqEd.RightAngleBracket.prototype.updateBracketStructure = function() {
        ...
        if (this.heightRatio <= 1.5) {
            ...
            this.wholeBracket = new eqEd.RightAngleWholeBracket("MathJax_Size3", this.fontMetrics);
            this.wholeBracket.parent = this;
            this.domObj.append(this.wholeBracket.domObj);
            this.children = [this.wholeBracket];
        } else {
            this.wholeBracket = new eqEd.RightAngleWholeBracket("MathJax_Size4", this.fontMetrics);
            this.wholeBracket.parent = this;
            this.domObj.append(this.wholeBracket.domObj);
            this.children = [this.wholeBracket];
        }
